...
- 1. 태그별 평가 수를 통한 사용자 관심도 산출
- 2. 태그별 평균 긍정 평가 비율을 통한 사용자 만족도 산출
- 3. 리뷰 수와 긍정 평가 비율이 모두 높은 게임군 식별
- 4. 태그별 게임 출시 수를 통해 시장 내 경쟁 밀도 측정
- 5. 레드오션 장르를 제외한 고성과군 장르를 추출하여 블루오션 영역 도출
""")
