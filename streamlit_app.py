...
st.write("""
연구 배경
Steam에는 수만 개의 게임이 등록되어 있으며 다양한 장르가 경쟁하고 있다. 그러나 모든 장르가 동일한 수준의 경쟁과 성과를 보이는 것은 아니다. 일부 장르는 많은 게임이 출시되는 레드오션 시장을 형성하는 반면, 상대적으로 경쟁이 적으면서도 높은 성과를 보이는 장르도 존재한다.

연구 목적
본 분석의 목적은 Steam 게임 데이터를 활용하여 경쟁이 과도하게 집중된 장르를 식별하고, 상대적으로 경쟁이 적으면서도 성공 가능성이 높은 블루오션 장르를 탐색하는 것이다.
""")
